...
def render_prompt(demos: List[Dict], evidence_snippets: List[str], profile_a: Dict, profile_b: Dict, context: Dict, version: str="v1") -> Dict:
    demos_block = []
    for d in demos:
        demos_block.append(
    ...
    header = f"### PROMPT_VERSION: {version}"
    user_text = f"""{header}
